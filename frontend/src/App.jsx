          ...
          <Router>
            <Routes>
              ...
              <Route path="/admin" element={<AdminLayout />}>
                ...
                <Route
                  path="residents"
                  element={<AdminPages.ResidentManagement />}
                />
                <Route path="shops" element={<AdminPages.ShopManagement />} />
                <Route
                  path="maintenance"
                  element={<AdminPages.BillManagement />}
                />
                <Route
                  path="payments"
                  element={<AdminPages.PaymentRecords />}
                />
                <Route
                  path="expenses"
                  element={<AdminPages.ExpenseTracker />}
                />
                <Route path="staff" element={<AdminPages.StaffManagement />} />
                <Route
                  path="committee"
                  element={<AdminPages.CommitteeManagement />}
                />
                <Route
                  path="vehicles"
                  element={<AdminPages.VehicleVisitorLog />}
                />
                <Route path="deliveries" element={<AdminPages.DeliveryLog />} />
                <Route
                  path="complaints"
                  element={<AdminPages.ComplaintManagement />}
                />
                <Route
                  path="notices"
                  element={<AdminPages.EventsAnnouncements />}
                />
                <Route path="documents" element={<AdminPages.DocumentRepo />} />
                <Route
                  path="emergency"
                  element={<AdminPages.EmergencyManagement />}
                />
                <Route
                  path="reports"
                  element={<AdminPages.ReportsAnalytics />}
                />
                <Route path="settings" element={<AdminPages.AdminSettings />} />
                <Route path="bookings" element={<AdminPages.AssetBooking />} />
                <Route
                ...
                <Route
                  path="surveillance"
                  element={<AdminPages.SmartSurveillance />}
                />
                <Route
                  path="attendance"
                  element={<AdminPages.AttendanceLogs />}
                />
                <Route path="marketplace" element={<AdminMarketplace />} />
                <Route
                ...
                <Route
                  path="traceback"
                  element={<AdminPages.LostAndFoundTraceback />}
                />
                <Route
                  path="traceback/report-lost"
                  element={<AdminPages.ReportLostItem />}
                />
                <Route
                  path="traceback/report-found"
                  element={<AdminPages.ReportFoundItem />}
                />
                <Route
                  path="traceback/matches"
                  element={<AdminPages.TracebackMatches />}
                />
                <Route
                  path="traceback/inventory"
                  element={<AdminPages.TracebackMatches />}
                />
                <Route
                  path="traceback/claims"
                  element={<AdminPages.TracebackMatches />}
                />
                <Route
                  path="traceback/prove-ownership"
                  element={<AdminPages.ProveOwnership />}
                />
                <Route
                  path="traceback/claim-review"
                  element={<AdminPages.FinderClaimReview />}
                />
              </Route>
              ...
              <Route path="/resident" element={<ResidentLayout />}>
                ...
                <Route
                  path="history"
                  element={<ResidentPages.PaymentHistory />}
                />
                <Route path="vehicles" element={<ResidentPages.Vehicles />} />
                <Route path="visitors" element={<ResidentPages.Visitors />} />
                <Route
                  path="complaints"
                  element={<ResidentPages.Complaints />}
                />
                <Route
                  path="announcements"
                  element={<ResidentPages.Announcements />}
                />
                <Route path="documents" element={<ResidentPages.Documents />} />
                <Route path="emergency" element={<ResidentPages.Emergency />} />
                <Route path="staff" element={<ResidentPages.Staff />} />
                <Route
                  path="settings"
                  element={<ResidentPages.ResidentSettings />}
                />
                <Route
                  path="bookings"
                  element={<ResidentPages.AssetBooking />}
                />
                <Route
              ...
              <Route path="/security" element={<SecurityLayout />}>
                ...
                <Route
                  path="visitors"
                  element={<SecurityPages.VisitorEntry />}
                />
                <Route
                  path="vehicles"
                  element={<SecurityPages.VehicleEntry />}
                />
                <Route
                  path="deliveries"
                  element={<SecurityPages.Deliveries />}
                />
                <Route
                  path="emergency"
                  element={<SecurityPages.EmergencyLogs />}
                />
                <Route
                  path="settings"
                  element={<SecurityPages.SecuritySettings />}
                />
                <Route
                  path="preapproved"
                ...
                <Route
                  path="attendance"
                  element={<SecurityPages.StaffAttendance />}
                />
                <Route
                  path="traceback"
                  element={<AdminPages.LostAndFoundTraceback />}
