...
const ListingCard = ({
  ...
  return (
    <div
      className={`mp-listing-card ${listing.premium ? "premium" : ""}`}
    ...
    >
      <div className="mp-card-image">
        ...
        <div className="mp-card-badges">
          ...
          {listing.type && (
            <span
              className={`mp-status ${listing.type === "sale" ? "mp-status-sold" : "mp-status-rented"}`}
            >
        ...
        {showFav && (
          <button
            className={`mp-card-fav ${isFav ? "active" : ""}`}
            onClick={handleFav}
      ...
      <div className="mp-card-body">
        <div className="mp-card-price">
          ...
          {listing.type === "rent" && (
            <span className="mp-price-label"> /month</span>
          )}
        </div>
        ...
        <div className="mp-card-specs">
          <span className="mp-card-spec">
            <Bed size={14} /> {listing.bedrooms} Bed
          </span>
          <span className="mp-card-spec">
            <Bath size={14} /> {listing.bathrooms} Bath
          </span>
          <span className="mp-card-spec">
            <Maximize size={14} /> {listing.area} sq.ft
          </span>
        </div>
