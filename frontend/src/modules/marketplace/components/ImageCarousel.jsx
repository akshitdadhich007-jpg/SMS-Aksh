    ...
    return (
      <div className="mp-carousel">
        <div className="mp-carousel-placeholder">
          <span>🏠</span>
          <p style={{ fontSize: 14, color: "inherit", opacity: 0.7 }}>
            No images uploaded
          </p>
        </div>
      </div>
  ...
  return (
    <div className="mp-carousel">
      ...
      {images.length > 1 && (
        <>
          <button
            className="mp-carousel-nav prev"
          ...
          <button
            className="mp-carousel-nav next"
            onClick={() => goTo(current + 1)}
            aria-label="Next image"
          >
            <ChevronRight size={20} />
          </button>
          <div className="mp-carousel-counter">
      ...
      {images.length > 1 && (
        <div className="mp-carousel-dots">
          {images.map((_, i) => (
            <button
              key={i}
              className={`mp-carousel-dot ${i === current ? "active" : ""}`}
              onClick={() => goTo(i)}
