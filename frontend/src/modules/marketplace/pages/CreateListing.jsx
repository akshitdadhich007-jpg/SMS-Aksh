...
const CreateListing = () => {
  ...
  const handleSubmit = (status) => {
    ...
    if (status === "pending") {
      ...
      if (data.images.length === 0 && status === "pending")
        errs.images = "At least 1 image required";
      const existingFlat = state.listings.find(
        (l) =>
          l.flatNumber === data.flatNumber &&
          !["sold", "rented", "rejected"].includes(l.status),
      );
      if (existingFlat)
        errs.flatNumber = "A listing for this flat already exists";
    ...
    <div className="mp-page">
      ...
      <div className="mp-detail-section">
        <div className="mp-form">
          ...
          <div className="mp-form-row">
            <div className="mp-form-group">
              ...
              <div className="mp-toggle-group">
                <button
                  className={`mp-toggle-btn ${form.type === "sale" ? "active" : ""}`}
                  onClick={() => handleChange("type", "sale")}
                >
                  🏷️ Sale
                </button>
                <button
                  className={`mp-toggle-btn ${form.type === "rent" ? "active" : ""}`}
          ...
          {/* Property Details */}
          <h3 style={{ margin: "8px 0 0", color: "var(--text-primary)" }}>
            Property Details
          </h3>
          <div className="mp-form-row">
            <div className="mp-form-group">
              ...
              />
              {errors.flatNumber && (
                <span className="mp-error">{errors.flatNumber}</span>
              )}
            </div>
            <div className="mp-form-group">
              ...
              />
              {errors.bedrooms && (
                <span className="mp-error">{errors.bedrooms}</span>
              )}
            </div>
            <div className="mp-form-group">
              ...
              />
              {errors.bathrooms && (
                <span className="mp-error">{errors.bathrooms}</span>
              )}
            </div>
          </div>
          <div className="mp-form-row">
          ...
          <div className="mp-form-group">
            ...
            />
            {errors.description && (
              <span className="mp-error">{errors.description}</span>
            )}
          </div>
          ...
          <div className="mp-form-row">
            {form.type === "sale" ? (
              <div className="mp-form-group">
                ...
                />
                {errors.price && (
                  <span className="mp-error">{errors.price}</span>
                )}
              </div>
            ) : (
              <>
                <div className="mp-form-group">
                  ...
                  />
                  {errors.rent && (
                    <span className="mp-error">{errors.rent}</span>
                  )}
                </div>
                <div className="mp-form-group">
                  ...
                  />
                  {errors.deposit && (
                    <span className="mp-error">{errors.deposit}</span>
                  )}
                </div>
              </>
            )}
          ...
          <div className="mp-form-actions">
            <button className="mp-btn mp-btn-secondary" onClick={clearForm}>
