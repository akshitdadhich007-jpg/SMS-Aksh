...
const ListingDetails = () => {
  ...
  const handleVisit = () => {
    ...
    const alreadyBooked = state.visits.some(
      (v) =>
        v.listingId === id &&
        v.date === visitForm.date &&
        v.time === visitForm.time,
    );
    if (alreadyBooked) {
  ...
  const handleAddFeature = () => {
    ...
    if (
      customFeatures.some(
        (f) => f.label.toLowerCase() === newFeature.label.toLowerCase(),
      )
    ) {
  ...
  const isOwner =
    currentUser.name === listing.ownerName && currentUser.role === "resident";
  const furnishLabel = {
  ...
  return (
    <div className="mp-page">
      <button
        className="mp-btn mp-btn-secondary mb-16"
        onClick={() => navigate("/resident/marketplace")}
      >
      ...
      <div className="mp-detail">
        ...
        <div>
          ...
          <div className="mp-detail-section mt-16">
            <div
              style={{
                display: "flex",
          ...
          <div className="mp-detail-section">
            ...
            <div className="mp-specs-grid">
              <div className="mp-spec-item">
                <div className="mp-spec-icon">
                  <Bed size={18} />
                </div>
                <div className="mp-spec-info">
              ...
              <div className="mp-spec-item">
                ...
                <div className="mp-spec-info">
                  ...
                  <span>
                    {furnishLabel[listing.furnishing] || listing.furnishing}
                  </span>
                </div>
              </div>
              <div className="mp-spec-item">
                ...
                <div className="mp-spec-info">
                  <label>Parking</label>
                  <span>
                    {parkingLabel[listing.parking] || listing.parking}
                  </span>
                </div>
              </div>
            </div>
              ...
              >
                {listing.customFeatures.map((feat, idx) => (
                  <div
                    key={idx}
                    style={{
                      background: "var(--hover-bg, var(--background))",
                      padding: "8px 12px",
        ...
        <div className="mp-detail-sidebar">
          <div className="mp-detail-section">
            ...
            >
              ...
              <button
                className={`mp-btn ${isFav ? "mp-btn-danger" : "mp-btn-secondary"}`}
                onClick={() => {
                  toggleFavorite(id);
                  toast.success(
              ...
              <button className="mp-btn mp-btn-secondary" onClick={handleShare}>
                <Share2 size={16} /> Share Listing
              </button>

              {isOwner && !["sold", "rented"].includes(listing.status) && (
                <button
                  className="mp-btn mp-btn-secondary mt-16"
              ...
              {listing.ownerFlat && (
                <button
                  className="mp-btn mp-btn-warning"
            ...
            <div className="mp-owner-info">
              ...
              <div className="mp-owner-details">
                ...
                <p>
                  ...
                  />{" "}
                  Flat {listing.ownerFlat || listing.flatNumber}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <div className="mp-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mp-modal-footer">
              ...
              <button className="mp-btn mp-btn-primary" onClick={handleEnquiry}>
                <Send size={16} /> Send Enquiry
              </button>
            </div>
          </div>
        ...
        >
          <div className="mp-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mp-modal-footer">
              ...
              <button className="mp-btn mp-btn-success" onClick={handleVisit}>
      ...
      {showFeaturesModal && (
        ...
        >
          ...
          >
            <div className="mp-modal-header">
              <h2>Define Property Features</h2>
              <button
                className="mp-btn-icon"
                onClick={() => setShowFeaturesModal(false)}
              >
            ...
            <div className="mp-modal-body">
              <p
                ...
                className="mb-16"
              >
                Add custom highlights (e.g., "Italian Marble", "Smart Home").
              </p>

              <div
                className="mp-form gap-16 mb-16"
                style={{
                  display: "grid",
