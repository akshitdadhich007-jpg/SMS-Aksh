    ...
    <div className="mp-page">
      ...
      {pending.length === 0 ? (
        <EmptyState
          icon="✅"
          title="All caught up!"
          message="There are no pending listings to review."
        />
      ) : (
            ...
            <div key={l.id} className="mp-listing-card">
              ...
              <div className="mp-card-body">
                ...
                <div className="mp-card-flat">
                  Flat {l.flatNumber} · {l.bedrooms}BHK · {l.area} sq.ft
                </div>
                <p
                  style={{
                    fontSize: 13,
                ...
                >
                  By <strong>{l.ownerName || "Unknown"}</strong> ·{" "}
                  {timeAgo(l.createdAt)}
                </p>
                <p
                  style={{
                ...
                <div className="mp-card-footer">
                  <button
                    ...
                    onClick={() => {
                      approveListing(l.id);
                      toast.success(`Flat ${l.flatNumber} approved`);
                    }}
                  >
                  ...
                  <button
                    ...
                    onClick={() => {
                      rejectListing(l.id);
                      toast.warning(`Flat ${l.flatNumber} rejected`);
                    }}
                  >
                    <X size={14} /> Reject
                  </button>
