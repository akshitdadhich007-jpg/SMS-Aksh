          ...
          <div className="info-grid">
            ...
            <div className="info-item">
              ...
              <span className="info-value highlight">
                {upcomingApprovals.length}
              </span>
            </div>
            <div className="info-item">
              <span className="info-label">Total Approved</span>
              <span className="info-value">
                {upcomingApprovals.length + history.length}
              </span>
            </div>
          </div>
        </div>
                  ...
                  <div key={approval.id} className="approval-card upcoming">
                    <div className="approval-header">
                      <div className="approval-title">
                        ...
                        <span
                          className={`status-badge ${getStatusColor(approval.status)}`}
                        >
                    ...
                    <div className="approval-details">
                      ...
                      <div className="detail-item">
                        ...
                        <span className="detail-value">
                          {getPurposeLabel(approval.purpose)}
                        </span>
                      </div>
                      <div className="detail-item">
                ...
                {history.map((approval) => (
                  <div key={approval.id} className="history-card">
                    <div className="history-header">
                      <h4>{approval.visitorName}</h4>
                      <span className="approval-code-small">
                    ...
                    <div className="history-details">
                      ...
                      {approval.status === "cancelled" && (
                        <div className="detail-item">
                          ...
                          <span className="detail-value cancelled">
                            Cancelled
                          </span>
                        </div>
                      )}
