...
const MyBills = () => {
  ...
  const totalAmount = currentBill
    ? (currentBill.maintenance || 0) + (currentBill.additional || 0)
    : 0;
      ...
      <>
        ...
        <Card className="text-center p-8">
          ...
          <p className="text-gray-500 mt-2">
            You are all caught up! Check back next month.
          </p>
        </Card>
      </>
    );
        ...
        <div className="bill-card-container">
          ...
          <div className="bill-details">
            ...
            <div className="bill-row">
              ...
              <span className="bill-row-value">
                ₹{currentBill.additional.toLocaleString()}
              </span>
            </div>
          </div>
        ...
        <div className="mybills-right-section">
          ...
          <div className="bill-details-card">
            ...
            <div className="bill-details-content">
              <p>
                This bill includes standard monthly maintenance plus a quarterly
                amenities fee.
              </p>
              <p>
                For discrepancies, please raise a complaint under the 'Accounts'
                category.
              </p>
            </div>
          </div>
